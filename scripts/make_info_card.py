...
# ===========================================================================
HOST = "sangwaniya"   # shown as  sangwaniya@github  in the header

# Playful, Cheems-in-a-suit themed placeholders -- swap in your real details.
ROWS = [
    ("host",),
    ("kv", "Now", "Shipping code in a suit @ Doge Corp"),
    ("kv", "Prev", "Full-time meme, part-time dev"),
    ("kv", "Also", "Turning caffeine into commits"),
    ("kv", "Edu", "School of Hard Knocks '20"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, JavaScript, TypeScript"),
    ("kv", "Frontend", "React, Next.js, Tailwind"),
    ("kv", "Backend", "Node, Postgres, REST"),
    ("kv", "Tooling", "Git, Docker, Linux"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Very code. Much deploy. Wow."),
    ("bul", "Ships to prod and lives to bark about it"),
]
